...
public class computingtax {
	...
	public static void main(String[] args) {
		...
		System.out.print(("0-single filer, 1-married jointly or widowed, 2-married separately, 3-head of household"));
		...
		System.out.println("Your taxes are " + (int)(tax * 100) / 100.0);
